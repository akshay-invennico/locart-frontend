  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="relative">
            <Input
              ...
              className={`w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-1.5 sm:py-2 h-10 sm:h-12 placeholder:text-placeholder-color border ${errors.email ? "border-red-500" : "border-[#E4E4E6]"
            ...
            <CiMail
              size={18}
              className={`absolute top-1/2 left-3 -translate-y-1/2 ${emailFocused ? "text-black" : "text-gray-500"
                }`}
            />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="relative">
            <Input
              ...
              className={`w-full pl-9 sm:pl-10 pr-9 sm:pr-10 py-1.5 sm:py-2 h-10 sm:h-12 placeholder:text-placeholder-color border ${errors.password ? "border-red-500" : "border-[#E4E4E6]"
                } rounded text-sm sm:text-base`}
            ...
            <LuLock
              size={18}
              className={`absolute top-1/2 left-3 -translate-y-1/2 ${passwordFocused ? "text-black" : "text-gray-400"
                }`}
            />
            {showPassword ? (
              <LuEyeOff
        ...
        <div className="flex items-center justify-between text-xs sm:text-sm flex-wrap gap-2">
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <label
              htmlFor="rememberMe"
              className="text-[#7B7B7B] whitespace-nowrap"
            >
              Keep me logged in
            </label>
          </div>
        ...
        <Button
          ...
          className="bg-primary1 hover:bg-primary1/80 text-white h-12 rounded-md mt-5 disabled:opacity-70"
        >
          {loginLoading ? (
      ...
      <div className="mt-14 w-full">
        <p className="text-center text-[#7B7B7B] text-xs leading-tight">
